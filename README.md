...
- Async processing & event-driven flows  
- Scalable deployments & infrastructure  
...
- Built a **distributed recruitment platform (5 microservices)** with secure APIs, Kafka-based async processing, and AWS deployment  
